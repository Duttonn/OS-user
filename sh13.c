...
int main(int argc, char ** argv)
{
	...
	deck[0] = IMG_Load("images/SH13_0.png");
	deck[1] = IMG_Load("images/SH13_1.png");
	deck[2] = IMG_Load("images/SH13_2.png");
	deck[3] = IMG_Load("images/SH13_3.png");
	deck[4] = IMG_Load("images/SH13_4.png");
	deck[5] = IMG_Load("images/SH13_5.png");
	deck[6] = IMG_Load("images/SH13_6.png");
	deck[7] = IMG_Load("images/SH13_7.png");
	deck[8] = IMG_Load("images/SH13_8.png");
	deck[9] = IMG_Load("images/SH13_9.png");
	deck[10] = IMG_Load("images/SH13_10.png");
	deck[11] = IMG_Load("images/SH13_11.png");
	deck[12] = IMG_Load("images/SH13_12.png");

	objet[0] = IMG_Load("images/SH13_pipe_120x120.png");
	objet[1] = IMG_Load("images/SH13_ampoule_120x120.png");
	objet[2] = IMG_Load("images/SH13_poing_120x120.png");
	objet[3] = IMG_Load("images/SH13_couronne_120x120.png");
	objet[4] = IMG_Load("images/SH13_carnet_120x120.png");
	objet[5] = IMG_Load("images/SH13_collier_120x120.png");
	objet[6] = IMG_Load("images/SH13_oeil_120x120.png");
	objet[7] = IMG_Load("images/SH13_crane_120x120.png");

	gobutton = IMG_Load("images/gobutton.png");
	connectbutton = IMG_Load("images/connectbutton.png");
   ...
   ret = pthread_create ( & thread_serveur_tcp_id, NULL, fn_serveur_tcp, NULL);
	...
	if (SDL_PollEvent(&event))
	{
		...
		switch (gbuffer[0])
		{
			...
			// Message 'M' : joueur courant
			case 'M':
			{
			int joueur;
			sscanf(gbuffer, "M %d", &joueur);
			goEnabled = (joueur == gId);
			break;
			}

			// Message 'V' : une valeur de tableCartes
			case 'V':
			{
			int col, val;
			sscanf(gbuffer, "V %d %d", &col, &val);
			tableCartes[gId][col] = val;
			break;
			}
		}
		synchro=0;
